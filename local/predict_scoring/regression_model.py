...
if __name__ == "__main__":
    ...
    print("               LinearModel")
    print("=================================================")
    for speaker_group in ['LARY', 'PARE', 'CTRL']:
        k_folds = 10
        num_epochs = 100
        learningRate = 1e-5
        kfold = KFold(n_splits=k_folds, shuffle=True)
        
        dataset = df.loc[df.speaker_group == speaker_group]
        ...
        print(f'{speaker_group} group: K-Fold cross validation fold_results for {k_folds} folds')
        sum = 0.0
